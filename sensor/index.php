...
<div class="container my-3">
  <h1 style="text-align: center;" class="text-dark">Informasi Suhu</h1>
  <br>
                  ...
                  <table border="1" style="margin: auto;" width="1000px" height="200px">
                    <thead>
                      <tr style="text-align: center;">
                       <th width="100px">Id_Sensor</th>
                        <th width="100px">Nama Sensor</th>
                ...
                ?>
                      <tr align="center">
                        ...
                        <td><?php echo $row['nilai'];?></td>
                         <td scope="row">
                           <a href="edit.php?id=<?php echo $row['id_sensor'];?>"><button type="button" class="btn btn-warning">Edit</button></a>
                           <a href="hapus.php?id=<?php echo $row['id_sensor'];?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                        </td>
                  </tr>
                  <?php } ?>
                </tbody>
